...
//          NONE
//------------------------------------------------------------------// 
void CB_PCM_CH2_InitDac(CH_TypeDef *chx,U16 sample_rate)
{    
...
//          NONE
//------------------------------------------------------------------// 
void CB_PCM_CH2_DacCmd(CH_TypeDef *chx,U8 cmd)
{    
    DAC_Cmd(chx,cmd);
}    
//------------------------------------------------------------------//
...
//          NONE
//------------------------------------------------------------------// 
void CB_PCM_CH2_WriteDac(U8 size,U16* psrc16)
{    
    U8 i;
...
//          NONE
//------------------------------------------------------------------//
void CB_PCM_CH2_ChangeSR(CH_TypeDef *chx,U16 sample_rate)
{ 
